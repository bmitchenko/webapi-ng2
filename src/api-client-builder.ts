...
import { ApiExplorerGenerator } from './generators/api-explorer/api-explorer-generator';

var request = require("request");
//var Promise = require('promise');

export class ApiClientBuilder {
    private _apiDescription: any;
    ...
    public configure(config: GeneratorConfig): ApiClientBuilder {
        this._config = config;
        return this;
    }

    public enableFormatting(): ApiClientBuilder {
        this._format = true;
        return this;
    }
    ...
    private generateScript(): Promise<any> {
        ...
        switch (this._config!.specification) {
            case 'api-explorer':
                let generator = new ApiExplorerGenerator();
